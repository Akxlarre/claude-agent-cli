  ...
  try {
    ...
    if (normalizedPath.endsWith('.component.ts')) {
      if (normalizedPath.includes('features/')) {
        contextParts.push(
          ...
          '  - Botones: class="btn-primary" o class="btn-secondary" (utilities en tailwind.css).',
    ...
    if (normalizedPath.includes('src/app/') && normalizedPath.endsWith('.html')) {
      contextParts.push(
        ...
        '  - Botones: class="btn-primary" (CTA principal), class="btn-secondary" (accion secundaria). Definidos en tailwind.css.',
